...
class SegmentationNetwork(NeuralNetwork):
    ...
    @staticmethod
    def _compute_steps_for_sliding_window_my(patch_size: Tuple[int, ...], image_size: Tuple[int, ...], step_size: float) -> List[List[int]]:
        ...
        num_steps = [image_size[dim] - patch_size[dim] + 1 for dim in range(len(patch_size))]
        steps = []
