...
class nnUNetTrainerV2_AEPL(nnUNetTrainer):
    """
...
class nnUNetTrainerV2_AEPL_wow(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def initialize_network(self):
        ...
        net_nonlin = nn.LeakyReLU
        net_nonlin_kwargs = {'negative_slope': 1e-2, 'inplace': True}
        self.network = Generic_UNet_AEPL_wow(self.num_input_channels, self.base_num_features, self.num_classes,
                                    len(self.net_num_pool_op_kernel_sizes),
                                    self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
...
class nnUNetTrainerV2_AEPL_wob(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def initialize_network(self):
        ...
        net_nonlin = nn.LeakyReLU
        net_nonlin_kwargs = {'negative_slope': 1e-2, 'inplace': True}
        self.network = Generic_UNet_AEPL_wob(self.num_input_channels, self.base_num_features, self.num_classes,
                                    len(self.net_num_pool_op_kernel_sizes),
                                    self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
...
class nnUNetTrainerV2_AEPL_wowb(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def initialize_network(self):
        ...
        net_nonlin = nn.LeakyReLU
        net_nonlin_kwargs = {'negative_slope': 1e-2, 'inplace': True}
        self.network = Generic_UNet_AEPL_wowb(self.num_input_channels, self.base_num_features, self.num_classes,
                                    len(self.net_num_pool_op_kernel_sizes),
                                    self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
...
class nnUNetTrainerV2_AEPL_wocls(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
...
class nnUNetTrainerV2_AEPL_wogamma(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def initialize_network(self):
        ...
        net_nonlin = nn.LeakyReLU
        net_nonlin_kwargs = {'negative_slope': 1e-2, 'inplace': True}
        self.network = Generic_UNet_AEPL_wogamma(self.num_input_channels, self.base_num_features, self.num_classes,
                                    len(self.net_num_pool_op_kernel_sizes),
                                    self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
...
class nnUNetTrainerV2_AEPL_0(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
...
class nnUNetTrainerV2_AEPL_001(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            with autocast():
                ...
                del data
                # pdb.set_trace()
                l = self.loss(output, target) + 0.01*self.ce(birads, birads_gt)
...
class nnUNetTrainerV2_AEPL_1(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            with autocast():
                ...
                del data
                # pdb.set_trace()
                l = self.loss(output, target) + self.ce(birads, birads_gt)
...
class nnUNetTrainerV2_AEPL_10(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            with autocast():
                ...
                del data
                # pdb.set_trace()
                l = self.loss(output, target) + 10. * self.ce(birads, birads_gt)
