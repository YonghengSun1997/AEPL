...
class nnUNetTrainerV2_AEPL_test(nnUNetTrainer):
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        # num_tumor_gt = data_dict['num_tumor_gt']
        ...
        if self.fp16:
            with (autocast()):
                output, num_tumor, birads = self.network(data)
                del data
                l = self.loss(output, target)
                # + self.ce(num_tumor, num_tumor_gt) + self.ce(birads, birads_gt)
