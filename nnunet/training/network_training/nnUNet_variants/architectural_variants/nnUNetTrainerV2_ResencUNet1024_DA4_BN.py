...
from nnunet.training.network_training.nnUNet_variants.architectural_variants.nnUNetTrainerV2_ResencUNet1024_DA4 import \
    nnUNetTrainerV2_ResencUNet1024_DA4
from nnunet.utilities.nd_softmax import softmax_helper


class nnUNetTrainerV2_ResencUNet1024_DA4_BN(nnUNetTrainerV2_ResencUNet1024_DA4):
    def initialize_network(self):
        ...
        self.network = FabiansUNet(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
                                   ...
                                   blocks_per_stage_decoder, True, False, 2048, InitWeights_He(1e-2))
