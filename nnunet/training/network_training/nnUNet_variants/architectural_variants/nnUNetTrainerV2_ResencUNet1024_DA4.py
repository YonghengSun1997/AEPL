...
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA4 import \
    nnUNetTrainerV2_DA4
from nnunet.utilities.nd_softmax import softmax_helper


class nnUNetTrainerV2_ResencUNet1024_DA4(nnUNetTrainerV2_DA4):
